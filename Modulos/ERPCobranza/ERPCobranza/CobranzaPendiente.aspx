<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CobranzaPendiente.aspx.cs" Inherits="ERPCobranza.CobranzaPendiente" %>
                ...
                <td>
                    <table id="crCobranza">
                        ...
                        <tr>
                            <td colspan="2">
                             <center>
                                   <asp:Button ID="Button1" class="boton" runat="server" Text="Cobrar Cobranza" OnClick="Button1_Click"></asp:Button>
                             </center>
                            </td>
                        </tr>
                   </table>
