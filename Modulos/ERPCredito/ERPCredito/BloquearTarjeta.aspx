<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BloquearTarjeta.aspx.cs" Inherits="ERPCredito.BloquearTarjeta" %>
...
<body id="fondo" onload="setInterval('elegido()', 500);">
    <form id="form1" runat="server">
       ...
       <tr>
           <td>
               <img id="eleccion2" src="Imagenes/iconBloquearTarj.png" height="80" width="80"/>
               <a class="eleccion">Bloquear Tarjeta</a>
           </td>
       </tr>
       <tr>
           <td>
                ...
                <td>
                    <table id="crCliente">
                        ...
                        <tr>
                            <td>
                                Estado: 
                                <asp:RadioButton ID="Bloqueado" runat="server" Text="Bloqueado" AutoPostBack="true" OnCheckedChanged="Bloqueado_CheckedChanged"/>
                                <asp:RadioButton ID="Vigente" runat="server" Text="Vigente" AutoPostBack="true" OnCheckedChanged="Vigente_CheckedChanged"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <center>
                                <asp:Button ID="Button1" class="boton" runat="server" Text="Bloquear Tarjeta" OnClick="Button1_Click"/>
                                </center>
                            </td>
                        </tr>
                   </table>
