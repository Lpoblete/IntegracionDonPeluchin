<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CargarTarjeta2.aspx.cs" Inherits="ERPCredito.CargarTarjeta2" %>
                ...
                <td>
                    <table id="crCliente">
                        ...
                        <tr>
                            <td>
                                Limite Credito<br/>
                                <asp:TextBox ID="limiteCred" runat="server" class="casilla" onkeydown="if (event.keyCode == 8) event.returnValue = false;" onkeypress="if (event.keyCode > 0) event.returnValue = false;"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <img src="Imagenes/iconMas.png" height="40" width="40"/>
                            </td>
                            <td>
                                Efectuar Cupo<br/>
                                <asp:TextBox ID="saldCargar" runat="server" class="casilla" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <center>
                                <asp:Button ID="Button1" class="boton" runat="server" Text="Efectuar Cupo" OnClick="Button1_Click"/>
