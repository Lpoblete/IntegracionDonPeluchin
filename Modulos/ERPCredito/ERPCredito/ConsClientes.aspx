<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsClientes.aspx.cs" Inherits="ERPCredito.ConsClientes" %>
            ...
            <tr>
                <td>
                    <table id="crCliente2">
                        ...
                        <tr>
                            <td align="center">
                                <asp:Button ID="Button1" class="boton" runat="server" Text="Buscar" OnClick="Button1_Click" />
                    ...
                    <table border="1" >
                        ...
                        <%
                            try
                            {
                                ...
                                {
                                    foreach(System.Data.DataRow cl in clientes.Rows)
                                    {
                             %>
                       <tr>
                            <td>
                            ...
                            <td>
                                <%=cl["Direccion_Cliente"].ToString() %>
                            </td>
                            <td>
                                <%=cl["Telefono_Cliente"].ToString() %>
                            </td>
                        </tr>
                        <%
                                    }
